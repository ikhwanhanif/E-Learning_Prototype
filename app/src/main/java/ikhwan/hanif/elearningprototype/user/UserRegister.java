                    ...
                    if (task.isSuccessful()) {
                        ...
                        reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    // Set the display name for the user in Firebase Authentication
                        ...
                        Toast.makeText(UserRegister.this, "Berhasil Daftar", Toast.LENGTH_SHORT).show();
                    } else {
                        progressDialog.dismiss();
                        Toast.makeText(UserRegister.this, "Gagal Daftar", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
