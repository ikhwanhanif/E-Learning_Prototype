...
public class AdminLogin extends AppCompatActivity {
    ...
    EditText et_email, et_password, et_adminCode;
    Button btn_login;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_adminCode = findViewById(R.id.adminCode);
    ...
    private void performLogin() {
        ...
        String admin = et_adminCode.getText().toString();
        ...
        if (email.isEmpty()) {
            ...
            if (admin.matches(adminCode)){
                ...
                Toast.makeText(AdminLogin.this,"kode admin yang anda masukkan salah", Toast.LENGTH_SHORT).show();
